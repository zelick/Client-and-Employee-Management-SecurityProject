...
//    private static final int ACCESS_TOKEN_EXPIRATION = 5 * 60 * 1000; // 5 minuta
//    private static final int REFRESH_TOKEN_EXPIRATION = 30 * 60 * 1000; // 30 minuta
    ...
    private static final int REFRESH_TOKEN_EXPIRATION = 3 * 60 * 1000; // 4 minuta
